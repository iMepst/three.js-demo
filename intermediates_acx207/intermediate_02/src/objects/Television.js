...
export default class Television extends THREE.Group {
    ...
    addParts() {
        ...
        corpusGeometry.computeVertexNormals(); //Calculate averaged vertex normal vectors
        ...
        cavityGeometry.computeVertexNormals(); //Calculate averaged vertex normal vectors
        cavityGeometry.translate(0, 0.4, 4);
        cavityGeometry.scale(1, 0.98, 1);
        const cavity = new THREE.Mesh(cavityGeometry, corpusMaterial);
        const corpusCSG = CSG.fromMesh(corpus); //Creation of CSG objects for the execution of "Boolean operations"
